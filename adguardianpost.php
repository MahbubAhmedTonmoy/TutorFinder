    ...
    <?php
        ...
        if (mysqli_num_rows($result) > 0)
        {
            while($row = mysqli_fetch_assoc($result))
            {
                ...
                echo "<td><a href=\"dltguardianpost.php?id=$row[post_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a> | <a href=\"appguardianpost.php?id=$row[post_id]\">Approve</a> </td>";
                echo "</tr>";
            }
