...
<table class="table table-striped table-bordered table-condensed">
    ...
    <?php
        ...
        $statement="select * from tutor_post_temp";
        ...
        if (mysqli_num_rows($result) > 0)
        {
            while($row = mysqli_fetch_assoc($result))
            {
                ...
                echo "<td><a href=\"dlttutorpost.php?id=$row[post_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a> | <a href=\"apptutorpost.php?id=$row[post_id]\">Approve</a> </td>";
                echo "</tr>";
            }
